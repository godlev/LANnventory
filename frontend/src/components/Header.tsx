        ...
        <ul class="navbar-nav wyl-navbar-actions">
          ...
          <li class="nav-item wyl-support-item">
            <button
              ...
              title="Support"
              aria-label="Support WatchYourLAN"
            ...
            <Show when={supportOpen()}>
              ...
              >
                <div id="support-popover-title" class="wyl-support-title">Support & Contact</div>
                <p>Every <a href="https://github.com/aceberg#donate" target="_blank" rel="noreferrer">donation</a> is truly appreciated!</p>
                <p>I am offering self-hosted and mobile apps development for a small price. The Open Source apps I created are listed in my <a href="https://aceberg.github.io/portfolio/" target="_blank" rel="noreferrer">portfolio</a>. They are all human-coded, not generated by AI. Please, <a href="https://github.com/aceberg#contact" target="_blank" rel="noreferrer">contact</a> me, if you are interested.</p>
              </div>
            </Show>
          </li>
          <li class="nav-item">
