...
func Routes(router *gin.Engine) {
	...
	r0 := router.Group("/api")
	{
		...
		r0.POST("/host/:id/proxmox/api/test", testHostProxmoxAPIConnection)
		r0.POST("/host/:id/proxmox/api/sync-preview", previewHostProxmoxAPISync)
		r0.POST("/host/:id/proxmox/api/sync-apply", applyHostProxmoxAPISync)
