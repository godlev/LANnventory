...
// @Param        eventType  query     string  false  "Repeatable event type filter" Enums(discovered, online, offline, known, unknown, device-type-changed, owner-changed, location-changed, notes-changed, tags-changed, pinned-changed, port-open, port-closed)
